 ...
 */
final class Version20231119213730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review_likes ADD CONSTRAINT FK_5A4462663E2E969B FOREIGN KEY (review_id) REFERENCES review (id)');
        $this->addSql('ALTER TABLE review_likes ADD CONSTRAINT FK_5A446266A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
